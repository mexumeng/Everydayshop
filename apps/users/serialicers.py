__author__ = "xumeng"
__date__ = "2018/11/29 11:49"


import re
from datetime import datetime, timedelta
from Everydayshop.settings import REGEX_MOBILE
...
class UserRegSerializer(serializers.ModelSerializer):
    ...
    password = serializers.CharField(label='密码', help_text='密码', write_only=True, required=True, allow_blank=False)
